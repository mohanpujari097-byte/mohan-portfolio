...
const siteUrl = "https://alexsharma-rwe.dev";

export const metadata: Metadata = {
  metadataBase: new URL(siteUrl),
  title: {
    default: "Alex Sharma | Healthcare Analytics & RWE Senior Business Analyst",
    template: "%s | Alex Sharma — Healthcare Analytics & RWE",
  },
  description:
  ...
  authors: [{ name: "Alex Sharma" }],
  creator: "Alex Sharma",
  openGraph: {
    type: "website",
    url: siteUrl,
    title: "Alex Sharma | Healthcare Analytics & RWE Senior Business Analyst",
    description:
    ...
    siteName: "Alex Sharma Portfolio",
    images: [
      {
        url: "/og-image.png",
        width: 1200,
        height: 630,
        alt: "Alex Sharma — Healthcare Analytics & Real-World Evidence",
      },
    ],
  },
  twitter: {
